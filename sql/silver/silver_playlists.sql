-- ============================================================
-- SILVER : playlists — nettoyage, typage, déduplication
-- ============================================================

CREATE OR REPLACE TABLE `YOUR_PROJECT.YOUR_SILVER_DATASET.playlists`
...
WITH ranked AS (
  SELECT
    ...
    items.total                                         AS track_count,  -- champ détecté par BigQuery
    -- Propriétaire
  ...
  FROM `YOUR_PROJECT.YOUR_BRONZE_DATASET.playlists`
