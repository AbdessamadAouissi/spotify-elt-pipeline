-- ============================================================
-- GOLD : insights playlists — taille, propriétaires, public/privé
-- ============================================================

CREATE OR REPLACE TABLE `YOUR_PROJECT.YOUR_GOLD_DATASET.playlist_insights`
AS
WITH bucketed AS (
  SELECT
    id,
    ...
    CASE
      ...
      ELSE 'mega (1000+)'
    END                                  AS size_bucket
  FROM `YOUR_PROJECT.YOUR_SILVER_DATASET.playlists`
